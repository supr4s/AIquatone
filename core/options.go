...
func ParseOptions() (Options, error) {
	options := Options{
		...
		ChromePath:        flag.String("chrome-path", "", "Full path to the Chrome/Chromium executable to use. By default, AIquatone will search for Chrome or Chromium"),
		...
		Version:           flag.Bool("version", false, "Print current AIquatone version"),
	}
